...
contract National_Cancer_Registry_of_Pakistan {
    ...
    constructor() {{
        ...
        datasetPolicies["0550cf66a193bc8a4af979e8621b4d5ef224a42ad1c574e64a4f974639c4e51c"] = "yes";
        datasetPolicies["d08cfcf9d5e4ff4ce9279126277b19bd31eb742e56508d300e1453cfed746eab"] = "yes";
        datasetPolicies["dbbb09cee9ab15080a0665a17218a1d43b4c09e06b8ebbfc483535dabf05d3f3"] = "yes";
        datasetPolicies["25d9d9f4fe48f317adcf2bcbd2089a640643e5ea2b00cd3990d96eef9912edbd"] = "yes";
    }}
    ...
    function evaluate(
        ...
        string memory term0,string memory term1,string memory term2,string memory term3,
        bytes memory signature
    ) public {{
        // Verifying the Signature first:
        string memory concatenatedInputs = concatenateInputs(inputs, term0,term1,term2,term3);
        require(
            verify(
                publicKey,
                concatenatedInputs,
        ...
        string[] memory term_values = new string[](4);
        string[] memory term_hashes = new string[](4);
    ...
    function concatenateInputs(string[] memory inputs, string memory term0,string memory term1,string memory term2,string memory term3) internal pure returns (string memory) {{
    ...
    function generateDecision(
        ...
        if (!permit) {{
            string[] memory failedTerms = new string[](4);
            uint count = 0;
            for (uint i = 0; i < 4; i++) {{
